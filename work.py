        ...
        with open('Basisdaten_Anschluesse.csv', newline='') as file:
            ...
            for line in linereader:
                if line[0] == self.anschlussnummer:
                    line[1] = Bringer(line[2], line[3])
                    line[4] = Bringer(line[5], line[6])
                    line[7] = Umsteigeregel()
...
def anschluss_2870():
    ...
    bn_th_s1 = Bringer('S1', 'Münsingen')
    ms_kf_160 = Bringer('160', 'Münsingen Bahnhof')
    an_2870a = Umsteigeregel('Anschluss 2870 A', '31.07.2020 06:01', '00:05:00', 2, 15, 15)
    an_2870b = Umsteigeregel('Anschluss 2870 B', '31.07.2020 06:31', '00:35:00', 2, 6, 14)

    anschluss2870 = Anschlussdefinition("2870", 'bn_th_s1', 'ms_kf_160', bn_th_s1, ms_kf_160, [an_2870a, an_2870b])
...
def anschluss_1260():
    ...
    ost_rub_s2 = Bringer('S2', 'Gümligen')
    fm_wb_6 = Bringer('6', 'Gümligen Bahnhof')
    an_1260a = Umsteigeregel('Anschluss 1260', '31.07.2020 21:21', '00:25:30', 2, 5, 15)
    an_1260b = Umsteigeregel('Anschluss 1260', '31.07.2020 21:51', '00:25:30', 2, 5, 15)


    anschluss1260 = Anschlussdefinition("1260", 'ost_rub_s2', 'fm_wb_6', ost_rub_s2, fm_wb_6, [an_1260a, an_1260b])
